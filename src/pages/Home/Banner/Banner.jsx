  ...
  return (
    <div className="relative h-screen">
      ...
      <div className="absolute inset-0 flex flex-col justify-around items-center text-center z-20">
       ...
       <div>
         <button className="group flex items-center gap-3 rounded-full bg-[#0F4C81] px-2 py-2 pl-6 text-white font-semibold shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
